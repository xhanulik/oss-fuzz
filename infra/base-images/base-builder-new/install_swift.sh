...
SWIFT_PACKAGES="wget binutils libc6-dev libcurl4 libedit2 libtinfo5 libgcc-9-dev libpython3.8 libsqlite3-0 libstdc++-9-dev libxml2 pkg-config tzdata zlib1g-dev"
...
SWIFT_RELEASE=swift-5.4.2-RELEASE-ubuntu20.04
wget -q https://swift.org/builds/swift-5.4.2-release/ubuntu2004/swift-5.4.2-RELEASE/$SWIFT_RELEASE.tar.gz
tar xzf $SWIFT_RELEASE.tar.gz
cp -r $SWIFT_RELEASE/usr/* /usr/
rm -rf $SWIFT_RELEASE.tar.gz $SWIFT_RELEASE
